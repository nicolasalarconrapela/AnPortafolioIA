    ...
    <>
        ...
        <div className="flex flex-col md:flex-row gap-6 p-6 rounded-3xl bg-[#0a101f] border border-slate-700/50 items-start md:items-center shadow-2xl relative overflow-hidden group animate-fade-in">
                ...
                <div className="flex-1 min-w-0 relative z-10">
                    <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mb-2">Candidate</h1>
                    <div className="flex flex-wrap items-center gap-3 text-sm mb-4">
                    <span className="text-cyan-400 font-bold">Open to Work</span> 
                    </div>
                    <div className="flex flex-wrap gap-4 md:gap-6 text-xs text-slate-400 font-medium">
                        <span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-sm">location_on</span> Remote / Hybrid</span>
                        <span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-sm">mail</span> email@example.com</span>
                    </div>
                </div>
        </div>
                    ...
                    <div className="relative overflow-hidden rounded-3xl border border-slate-700/50 bg-[#0a101f] p-6 lg:p-8 mb-8 flex flex-col md:flex-row items-center gap-8 shadow-2xl text-center md:text-left">
                         ...
                         <div className="flex-1 z-10">
                             <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                                 <h2 className="text-2xl md:text-3xl font-bold text-white">Candidate</h2>
                            ...
                            <div className="space-y-5 flex-1">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <input type="text" placeholder="Your Name" className="w-full bg-slate-900/80 border border-slate-700 rounded-xl px-4 py-3 text-white text-sm focus:border-cyan-500 outline-none transition-colors" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-bold text-slate-400 ml-1">Job Title</label>
                                        <input type="text" placeholder="e.g. Developer" className="w-full bg-slate-900/80 border border-slate-700 rounded-xl px-4 py-3 text-white text-sm focus:border-cyan-500 outline-none transition-colors" />
                                    </div>
                                </div>

                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-slate-400 ml-1">Bio</label>
                                    <textarea placeholder="Tell us about yourself..." className="w-full bg-slate-900/80 border border-slate-700 rounded-xl px-4 py-3 text-white text-sm focus:border-cyan-500 outline-none transition-colors h-32 resize-none" />
                                </div>
                            </div>
